...
loadStationsFromServer: function() {
  ...
  componentDidMount: function() {
    ...
    setInterval(this.loadStationsFromServer, this.props.pollInterval);
  },
  ...
  render: function() {
    return (
      <div className="stationBox">
        <h1>Late Trains!</h1>
        <h2>Putting the 'fun' into 'fundamentally late for a very important meeting you South West Train assholes!'</h2>
